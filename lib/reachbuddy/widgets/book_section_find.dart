...
class BookSection extends StatefulWidget {
  ...
  const BookSection(
      {super.key, required this.onIdSelected, required this.onTitleSelected});
                        ...
                        return Column(
                          children: [
                            Text(
                              ...
                              style:
                                  TextStyle(color: primaryColour, fontSize: 20),
                            ),
                            SizedBox(height: 8),
                          ],
                        );
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    // print("kamu klik judul ${title} dengan id $selectedBookPk");
                                    widget.onIdSelected(selectedBookPk);
                                    widget.onTitleSelected(title); // Update bookpk in FindBuddy
                                  },
                                  child: Container(
                                    height: 160,
