...
class _ThreadsPageState extends State<ThreadsPage> {
  ...
  Future<List<Threads>> fetchThreads() async {
    var url = Uri.parse('http://127.0.0.1:8000/reachbuddy/get-threads-flutter/');
                    ...
                    return Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.network(thread.bookImage, fit: BoxFit.cover),
                            SizedBox(height: 10),
                            Text(
                              thread.bookTitle,
                              style: TextStyle(
                            ...
                            Row(
                              ...
                              children: [
                                CircleAvatar(
                                  backgroundImage: NetworkImage(thread.profileImage),
                                ),
                                SizedBox(width: 10),
                                Expanded(
                                  child: Column(
